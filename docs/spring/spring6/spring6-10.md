...
```java
package com.doyo.spring6.validation.method1;
...
```java
@Configuration
@ComponentScan("com.doyo.spring6.validation.method2")
...
```java
package com.doyo.spring6.validation.method2;
...
```java
package com.doyo.spring6.validation.method3;
...
@Configuration
@ComponentScan("com.doyo.spring6.validation.method3")
public class ValidationConfig {
...
```java
package com.doyo.spring6.validation.method4;
