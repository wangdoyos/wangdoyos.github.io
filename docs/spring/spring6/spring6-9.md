...
```java
package com.doyo.spring6.javai18n;
...
**（1）创建doyo_en_US.properties**

www.doyo.com=welcome {0},时间:{1}

**（2）创建doyo_zh_CN.properties**

www.doyo.com=欢迎 {0},时间:{1}
...
public class Demo2 {
    ...
    public static void main(String[] args) {
        ...
        Object[] objs = new Object[]{"doyo",new Date().toString()};

        //www.doyo.com为资源文件的key值,
        //objs为资源文件value值所需要的参数,Local.CHINA为国际化为语言
        String str=context.getMessage("www.doyo.com", objs, Locale.CHINA);
